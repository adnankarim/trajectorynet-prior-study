...
def integrate_backwards(
    ...
    with torch.no_grad():
        ...
        zs = torch.stack(zs, 0)
        zs = zs.cpu().numpy()
        np.save(os.path.join("/home/mint/Desktop/project/cycle/tmp/backward_trajectories.npy"), zs)
...
def main(args):
    ...
    state_dict = torch.load("/home/mint/Desktop/project/cycle/tmp/checkpt.pth", map_location=device)
    ...
    print("integrating backwards ended")
    # exit()
    losses_list = []
